...
|----|-------|---------|--------|
| FR-1 | Java Record: Default Serialization | `api/`, `spec/`, `tck/` | ✅ DONE |
| FR-2 | Java Record: Default Deserialization | `api/`, `spec/`, `tck/` | ✅ DONE |
| FR-3 | Java Record: Annotation Support | `api/`, `spec/`, `tck/` | 🔄 IN PROGRESS |
| FR-4 | Java Record: Virtual Attributes | `api/`, `spec/`, `tck/` | ✅ DONE |
| FR-5 | UUID Default Mapping | `spec/`, `tck/` | ✅ DONE |
| FR-6 | Spec/API Name Consistency: @JsonbTypeSerializer/@JsonbTypeDeserializer | `spec/` | ✅ DONE |
| FR-7 | @JsonbPropertyOrder Semantic Clarification | `api/`, `spec/`, `docs/` | ⬜ TODO |
| FR-8 | @JsonbNumberFormat Locale Documentation and TCK Coverage | `api/`, `tck/` | 🔄 IN PROGRESS |
