...
* Class field or record component is annotated with `@JsonbTransient`
** Exception must be thrown when this field, record component, getter or setter is annotated with other JSON Binding annotations.
