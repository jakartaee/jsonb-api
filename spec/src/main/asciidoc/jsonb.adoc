...
<!-- TODO are attribute orders lexicographical for records as well?  If so this needs to be updated -->

Class properties MUST be serialized in lexicographical order into the resulting JSON document.
